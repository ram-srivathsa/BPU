...
//
// On Thu Jun 14 10:56:28 IST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkbtb(CLK,
  ...
  input  [45 : 0] ma_update_update_val;
  input  EN_ma_update;
  ...
  assign MUX_bram_way1$b_put_1__SEL_1 =
	     EN_ma_update && ma_update_update_val[1:0] == 2'b0 ;
  assign MUX_bram_way2$b_put_1__SEL_1 =
	     EN_ma_update && ma_update_update_val[1:0] == 2'b01 ;
  assign MUX_bram_way3$b_put_1__SEL_1 =
	     EN_ma_update && ma_update_update_val[1:0] == 2'b10 ;
  assign MUX_bram_way4$b_put_1__SEL_1 =
	     EN_ma_update && ma_update_update_val[1:0] == 2'b11 ;
